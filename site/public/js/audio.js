...
const CANVAS_TIME_BACKGROUND = $(document.body).css('background-color');
const CANVAS_TIME_FOREGROUND = $(document.body).css('color');
const CANVAS_TIME_LINEWIDTH = 2;
const CANVAS_TIME_SAMPLE_OFFSET = -127.5;
const CANVAS_TIME_SAMPLE_SCALE = 1 / 64;

const CANVAS_FREQUENCY_BACKGROUND = $(document.body).css('background-color');
const CANVAS_FREQUENCY_FOREGROUND = $(document.body).css('color');
